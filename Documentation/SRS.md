...
Данное приложение разрабатывалось и тестировалось на ОС Windows, поэтому наиболее стабильная работа предполагает работу приложения в этой операционной системе.
